...
```{r, echo=FALSE, fig.align='right', fig.margin=T}
knitr::include_graphics("./img/R_logo.svg.png",dpi=700)
```
...
In R, objects cab be modified in many ways:
...
```{r, echo=T, include=T,message=T}
x <- rnorm(1000,mean=10) # create a vector from 1 to 10
...
```{r, echo=T, include=T,message=T}
m[2:3,c(5,6,9)] # extract the values of the 2nd and third row in the 5th, 6th and 9th column 
...
Let's assume you got 1000 euros to do a pilot study on the genetic basis of drug addition.
...
```{r, echo=T, include=F,message=T,fig.height=3.5}
